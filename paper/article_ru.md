...
Классическая обработка заняла 3.4 мс/изображение на CPU. Все числа автоматически связаны
...
обработки — 3.4 мс/изображение. Статус lightweight CNN: `completed`; отсутствующий
