...
Classical processing required 3.4 ms/image on CPU. The work supplies an auditable baseline
...
averaged 3.4 ms/image. The ablation, confidence intervals, per-sample predictions and
